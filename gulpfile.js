...
// Project related.
var project                 = 'Travis County Archives'; // Project Name.
var projectURL              = 'localhost:8888/archives'; // Local project URL of your already running WordPress site. Could be something like local.dev or localhost:8888.
...
var bugReport               = 'https://traviscountyhistory.org/contact-the-archives/'; // Where can users report bugs.
var lastTranslator          = 'Hagan Barber <hagan.barber@traviscountytx.gov>'; // Last translator Email ID.
var team                    = 'WPTie <hagan.barber@traviscountytx.gov>'; // Team's Email ID.
...
var vendorJSWatchFiles      = './js/vendors/*.js'; // Path to all vendor JS files.
