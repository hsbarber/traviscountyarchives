...
<main class="hd2023-overflow">
    <div class=" container-fluid" style="background:
    url('<?php echo the_field('hd2023-title-bg') ?>') 50% 50% no-repeat; background-size: cover;">
        <div class="container-xxl hd2023-bg-spacing">

        </div>
    </div>
    <div class=" container-fluid hd2023-title">
        <div class="container-xxl">
            <div class=" row d-flex flex-column justify-content-center align-items-center py-5">
                <div class="col-sm-6 col-md-4 ">
                    <?php the_field('hd2023-header-title'); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="container-xxl">
            <div class="row justify-content-center ">
                <div class="col-sm-12 col-md-8  px-5 hd2023-block-padding hd2023-oralhistories">
    ...
    <section id="countyclerk">
        <div class="container-fluid">
            <div class="container-xxl">
                ...
                <div class="row ">
                    <div class="col-sm-12 col-md-8 px-5 py-5 mb-5">
                        <?php the_field('block-1-text-1') ?>
                    </div>
                    <div class="col-sm-12 col-md-4 px-5 py-5 mb-5">
                        <?php
